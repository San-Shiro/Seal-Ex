package com.sanshiro.sealEx.ui.page.settings.general
...
import com.sanshiro.sealEx.ui.component.PreferenceSwitch
import com.sanshiro.sealEx.ui.component.PreferenceSwitchWithDivider
import com.sanshiro.sealEx.ui.component.SealDialog
import com.sanshiro.sealEx.ui.page.download.NotificationPermissionDialog
import com.sanshiro.sealEx.util.CONFIGURE
import com.sanshiro.sealEx.util.CUSTOM_COMMAND
import com.sanshiro.sealEx.util.DEBUG
import com.sanshiro.sealEx.util.DISABLE_PREVIEW
import com.sanshiro.sealEx.util.DOWNLOAD_ARCHIVE
import com.sanshiro.sealEx.util.EXTERNAL_SERVICE
import com.sanshiro.sealEx.external.ExternalDownloadService
import com.sanshiro.sealEx.util.FileUtil.getArchiveFile
import com.sanshiro.sealEx.util.NOTIFICATION
import com.sanshiro.sealEx.util.NotificationUtil
import com.sanshiro.sealEx.util.PLAYLIST
import com.sanshiro.sealEx.util.PRIVATE_MODE
...
import com.sanshiro.sealEx.util.SPONSORBLOCK
...
import com.sanshiro.sealEx.util.YT_DLP_VERSION
    ...
    Scaffold(
        ...
        content = {
            ...
            LazyColumn(modifier = Modifier, contentPadding = it) {
                ...
                item {
                    var isExternalServiceEnabled by EXTERNAL_SERVICE.booleanState
                    PreferenceSwitch(
                        title = stringResource(R.string.external_service),
                        description = stringResource(R.string.external_service_desc),
                        icon = if (isExternalServiceEnabled) Icons.Outlined.LeakAdd else Icons.Outlined.LeakRemove,
                        isChecked = isExternalServiceEnabled,
                        enabled = !isCustomCommandEnabled,
                        onClick = {
                            isExternalServiceEnabled = !isExternalServiceEnabled
                            PreferenceUtil.updateValue(EXTERNAL_SERVICE, isExternalServiceEnabled)
                            
                            val newState = if (isExternalServiceEnabled) {
                                PackageManager.COMPONENT_ENABLED_STATE_ENABLED
                            } else {
                                PackageManager.COMPONENT_ENABLED_STATE_DISABLED
                            }
                            context.packageManager.setComponentEnabledSetting(
                                ComponentName(context, ExternalDownloadService::class.java),
                                newState,
