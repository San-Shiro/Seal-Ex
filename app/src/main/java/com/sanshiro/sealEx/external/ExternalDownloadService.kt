...
import com.sanshiro.sealEx.IExternalDownloadService
import com.sanshiro.sealEx.MainActivity
import com.sanshiro.sealEx.util.NotificationUtil
import com.sanshiro.sealEx.util.NotificationUtil.SERVICE_NOTIFICATION_ID
 ...
 * ```
 * val intent = Intent("com.sanshiro.sealEx.action.EXTERNAL_DOWNLOAD")
 * intent.setPackage("com.sanshiro.sealEx")
